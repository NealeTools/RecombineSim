...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fid1 = fopen('ChrSizesS288cH4L2_L2HG.txt.txt','r');
...
for m = 1:3:size(eventcount,2)
    ...
    for h=1:3
            ...
            rIED = IED(:,h);
            rIED(rIED==0)= [];
            rIED = [2000;4000;6000;8000;10000;12000;14000;16000;18000;20000]; %REMOVE
